...
Here, we fit a linear model for `log_count` predicted by the 3 most correlated variables: `temperature`, `dateTime`, and `humidity`.
...
In the end, our model yielded a Kaggle score of 1.20257. 